...
from docling_core.types.doc.document import (
    TextItem, TitleItem, SectionHeaderItem, ListItem, 
    TableItem, KeyValueItem, CodeItem, FormulaItem,
    NodeItem
)
...
class TextSegment:
    ...
    def relative_offset(self, global_offset: int) -> int:
        ...
        if not self.contains_offset(global_offset):
            raise ValueError(f"Offset {global_offset} not in segment range [{self.start_offset}, {self.end_offset})")
...
class TextExtractor:
    ...
    def _extract_from_text_item(
        self, 
        text_item: Union[TextItem, TitleItem, SectionHeaderItem, ListItem, CodeItem, FormulaItem],
        start_offset: int
    ) -> Optional[TextSegment]:
    ...
    def _extract_from_table_item(self, table_item: TableItem, start_offset: int) -> List[TextSegment]:
    ...
    def _extract_from_key_value_item(self, kv_item: KeyValueItem, start_offset: int) -> List[TextSegment]:
