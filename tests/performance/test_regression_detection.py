...
class TestPerformanceRegressionAnalyzer:
    ...
    def test_compare_benchmarks_stable_performance(
        self, analyzer, sample_baseline_data, sample_current_data_stable
    ):
    ...
    def test_compare_benchmarks_with_regressions(
        self, analyzer, sample_baseline_data, sample_current_data_regression
    ):
        ...
        try:
            ...
            assert (
                results["test_regression_baseline"]["status"] == "regression"
    ...
    def test_generate_report_with_regressions(self, analyzer):
        ...
        comparison_results = {
            ...
            "stable_benchmark": {"status": "stable", "change_pct": 2.0},
        }
...
class TestRegressionDetectionIntegration:
    ...
    def test_end_to_end_analysis_no_regression(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            results = analyzer.compare_benchmarks(
    ...
    def test_realistic_benchmark_thresholds(self):
        ...
        test_cases = [
            ...
            (
                ...
                0.09,
                "stable",
            ),  # Under important threshold
            (
                "test_round_trip_performance",
                0.11,
                "regression",
            ),  # Over important threshold
        ...
        for bench_name, change_ratio, expected_status in test_cases:
            ...
            baseline = PerformanceBenchmark(
                bench_name, baseline_mean, 0.010, 0.090, 0.110, 5
            )
            current = PerformanceBenchmark(
                bench_name, current_mean, 0.010, 0.090, current_mean + 0.020, 5
            )
