...
class ParallelTestSupport:
    ...
    @staticmethod
    def setup_worker_environment(worker_id: Optional[str] = None) -> dict[str, str]:
    ...
    def get_optimal_worker_count() -> int:
        ...
        max_workers = os.getenv('PYTEST_MAX_WORKERS', '8')
        min_workers = os.getenv('PYTEST_MIN_WORKERS', '1')
...
_worker_resource_manager: Optional[WorkerResourceManager] = None
